...
public class DispatchController extends BaseController
{
     ...
     * @return 请求返回结果
     */
    @RequestMapping(value = "/{serverName}/{methodName}.hzp", produces = "application/json;charset=UTF-8")
     ...
     * @return 请求返回结果
     */
    @RequestMapping(value = "/{serverName}/{fileName}/{methodName}.hzp", produces = "application/json;charset=UTF-8")
    public String dispatchRequest(@PathVariable("serverName") String serverName,
